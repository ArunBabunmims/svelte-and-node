<script>
    ...
    function editList(id) {
        console.log("id:::::::::", id);
        const objToEdit = lists.filter((val) => val.id === id);
        console.log(objToEdit);
        text = objToEdit[0].text;
        editId = objToEdit[0].id;
        isEditable = true;
    }
</script>
...
<div class="main-container">
    <div class="container">
        ...
        <div id="tasks">
            {#each lists as list}
                <div class="taskadded" transition:fade>
                    <span id="taskname">
                        {list.text}
                    </span>
                    ...
                    <div>
                        ...
                        >
                        <button class="edit" on:click={() => editList(list.id)}>
                            <i class="bx bx-edit" /></button
                        >
                    </div>
                </div>
            {/each}
